  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <h2 className="text-3xl text-white mt-4 mb-8">
        ...
        <div className="flex my-4">
          <input
            className="bg-white p-4 min-w-[400px] rounded-l"
            placeholder="Email address"
          />
          <button
            className="bg-[#e50914] flex items-center text-white text-xl px-8 rounded-r"
            onClick={() => signIn()}
          >
            Get Started!{" "}
            <svg
